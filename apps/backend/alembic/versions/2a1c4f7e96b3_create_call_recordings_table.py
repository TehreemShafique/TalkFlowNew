...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("mime_type", sa.String(length=64), server_default=sa.text("'audio/wav'"), nullable=True),
    ...
    op.create_index("uix_call_recordings_vicidial_recording_id", "call_recordings", ["vicidial_recording_id"], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index("uix_call_recordings_vicidial_recording_id", table_name="call_recordings")
