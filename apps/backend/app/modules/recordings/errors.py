...
register_error("recording.purged_or_expired", 410, "Recording has been purged or expired.")
...
register_error("recording.purge_unauthorized", 403, "Not authorized to purge this recording.")
...
RecordingSourceUnavailableError = ServiceUnavailableError  # code "recording.source_unavailable"
RecordingDownloadUnauthorizedError = PermissionDeniedError  # code "recording.download_unauthorized"
RecordingPurgeUnauthorizedError = PermissionDeniedError  # code "recording.purge_unauthorized"